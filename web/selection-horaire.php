<?php
    ...
    function Get_Prix($bdd){

        $requette = $bdd->query("SELECT * FROM specialite WHERE id_hopital =  '".$_POST['hopital']."' and nom =  '".$_POST['specialite']."'");
    ...
    function Get_Hopital($bdd){
        ...
        $requette = $bdd->query("SELECT * FROM hopital WHERE id = '".$_POST['hopital']."'");
...
<div class="container_1">
                ...
                <ul class="field-list" >
                    <li>
                        ...
                        <div class="form-input">
                            <p align="left"><?php  Get_Hopital($bdd);  ?></p>
                        </div>
                    </li>
                    <li>
                        <label class="form-label"> 
                        ...
                        <div class="form-input">
                            <p align="left"><?php echo  $_POST['medecins'];  ?></p>
                        </div>
                    </li>
                     ...
                     <li>
                        ...
                        <div class="form-input">
                            <p align="left"><?php Get_Prix($bdd);  ?> FCFA</p>
                        </div>
                    </li>
        ...
        <br>
            ...
            <br><br>
					<ul class="field-list">
						<li>
							...
							<input type="hidden" name="ville" id="ville" value="<?php echo  $_POST['ville'];  ?>">
							<input type="hidden" name="hopital" id="hopital" value="<?php echo  $_POST['hopital'];  ?>">
							<input type="hidden" name="specialite" id="specialite" value="<?php echo  $_POST['specialite'];  ?>">
							<input type="hidden" name="medecins1" id="medecins1" value="<?php echo  $_POST['medecins'];  ?>">
            ...
            <option value="">selectionner l'horaire ...</option>
					...
					</ul><br><label for="motif"> motif : </label>
