			...
			<div class="agile-form">
				<form  method="post">
					...
					<li>
							...
							<input type="hidden" name="hopital3" id="hopital4" value="<?php echo	  $nom_hopital;  ?>">
								<input type="text" name="nom" id="nom4" placeholder="Nom " required >
							</div>
						</li>
						<li>
							<label class="form-label"> 
							...
							<div class="form-input">
								<input type="text" name="prix" id="prix4" placeholder="prix consultation " required >
							</div>
						</li>
					
						
					</ul>
					<input type="submit" value="Valider" id="save_specialite1">
				</form>	
			</div>
		</div>
...
<div class="container">
		<div class="heading">
				<h2>Spécialités enregistrées <ul><h4><li id="refresh3" class="fa fa-refresh"></li></h4></ul></h2>
				...
				<div class="col-md-12">
        <div class="tab1"><div id="charge2"></div></br></div>
			</div>
