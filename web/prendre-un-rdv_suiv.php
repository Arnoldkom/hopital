    ...
    <div class="about">
        <div class="container">
           ...
           <label for="region">CHoisir sa regions : </label><ul><li id="test1" class="fa fa-refresh"></li></ul>
            ...
            <option value="">selectionner la régions ...</option>
            <?php
            echo Get_Region($bdd);
            ?>
                                    </select></br></br>
            ...
            <?php
            echo Get_Specialite($bdd);
            ?>

                                        </select></br></br>
            <label for="medecin">Choisir le medecin : </label><ul><li id="test5" class="fa fa-refresh"></li></ul>
            <select name="medecin" class="medecins" id="medecins">
            <?php
            echo Get_Medecin($bdd);
            ?>
